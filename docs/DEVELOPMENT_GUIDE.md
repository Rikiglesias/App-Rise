...
```typescript
import {
  PerfectText, PerfectImage, PerfectContainer, useUniversalTheme
} from '@/components/ui';
...
const PerfectTextLogic = {
  ...
  calculateBaseSize: (inputSize: number) => {
    return responsiveSystem.scaleFont(inputSize);
  },
...
describe('Sistema Perfetto', () => {
  describe('responsiveSystem.ts', () => {
    it('should scale font correctly for all devices', () => {
      ...
      expect(responsiveSystem.scaleFont(32)).toBeCloseTo(29);
      
      // iPhone 15: 393px → 100% scaling
      mockDimensions(414);
      expect(responsiveSystem.scaleFont(32)).toBe(32);
      
      // iPad: 768px → 185.5% scaling
      mockDimensions(768);
      expect(responsiveSystem.scaleFont(32)).toBeCloseTo(59);
    });
  });
...
const TestingTargets = {
  ...
  criticalComponents: {
    responsiveSystem.ts: "100%",  // Sistema core
...
console.log('Device info:', responsiveSystem.getDatabaseDeviceInfo());

// Debug scaling calculations
console.log('Font 32 →', responsiveSystem.scaleFont(32));
  ...
  return (
    <PerfectContainer preset="modal" centered theme="auto">
      ...
      <PerfectContainer preset="section">
        ...
        <TextInput 
          style={{
            fontSize: responsiveSystem.scaleFont(16),
            padding: responsiveSystem.scaleSpacing(12)
          }}
        ...
        <TouchableOpacity 
          onPress={onSubmit}
  style={{
            padding: responsiveSystem.scaleSpacing(16),
            borderRadius: responsiveSystem.scaleSpacing(8)
          }}
        >

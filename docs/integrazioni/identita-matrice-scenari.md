...
| B3 | Ha **entrambi**, stessa email | Due account scollegati per sempre | Che LD colleghi i due sull'email | 📨 account linking (brief §4, 2° punto + domanda 4 di §5; nel documento di consegna è il punto 5) | Utente di test con account nativo → login RAH → un solo account |

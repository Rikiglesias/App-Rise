...
export const useUniversalTheme = (): ThemeContextType => {
  ...
  if (!context) {
    throw new Error('useUniversalTheme must be used within UniversalThemeProvider');
  }
  return context;
};

// 🎨 HELPER FUNCTIONS
export const getThemeColor = (colorKey: keyof typeof UNIVERSAL_COLORS.light, isDark: boolean) => {
  return isDark ? UNIVERSAL_COLORS.dark[colorKey] : UNIVERSAL_COLORS.light[colorKey];
};

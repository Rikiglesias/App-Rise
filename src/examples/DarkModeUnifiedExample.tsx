...
const DarkModeDemoContent: React.FC = () => {
  ...
  return (
    <ScrollView
      style={[styles.container, { backgroundColor: backgroundColor.primary }]}
    >
      <ResponsiveStack spacing={20} padding={20}>
        ...
        >
          ...
          <ResponsiveStack spacing={8}>
            ...
            />
            <BenefitItem icon="🎨" text="Consistent theming across app" />
            <BenefitItem icon="⚡" text="Zero manual color management" />
            <BenefitItem
              icon="🚀"

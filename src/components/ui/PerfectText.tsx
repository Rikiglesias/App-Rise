...
interface PerfectTextProps extends Omit<TextProps, 'numberOfLines' | 'adjustsFontSizeToFit'> {
...
export const PerfectTitle = (props: Omit<PerfectTextProps, 'lines' | 'fontWeight'>) => (
  <PerfectText {...props} lines={1} fontWeight="bold" />
);

export const PerfectSubtitle = (props: Omit<PerfectTextProps, 'lines' | 'fontWeight'>) => (

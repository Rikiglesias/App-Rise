...
function analyzeFile(filePath) {
  ...
  // Cerca Text di Paper
  if (content.includes('from \'react-native-paper\'') && content.includes('<Text')) {
...
function main() {
  ...
  if (!CONFIG.dryRun && results.modifiedFiles > 0) {
    ...
    console.log('💡 Esegui i test per verificare che tutto funzioni correttamente.');
    console.log('💡 Controlla i file modificati e aggiusta manualmente se necessario.');
  }
